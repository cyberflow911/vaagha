<?php
...

    {
        ...
        $sql = "select u.*, p.title as p_title, c.f_name as pmf_name, c.l_name as pml_name, p.termandcondition as tnc  from users u, projects p, com_admins c where u.com_id in ($cms) and u.p_id in ($pjs) and u.p_id=p.id and u.pm_id=c.id and u.pay_status=3 and p.termandcondition=1 and p.signortick=1 order by u.email_date";
...

    {
        ...
        $sql = "select u.*, p.title as p_title, c.f_name as pmf_name, c.l_name as pml_name, p.termandcondition as tnc  from users u, projects p, com_admins c where u.com_id in ($cms) and u.pm_id in ($pms) and u.p_id in ($pjs) and u.p_id=p.id and u.pm_id=c.id and u.pay_status=3 and p.termandcondition=1 and p.signortick=1 order by u.email_date";
...

    {
        ...
        $sql = "select u.*, p.title as p_title, c.f_name as pmf_name, c.l_name as pml_name, p.termandcondition as tnc  from users u, projects p, com_admins c where u.com_id in ($cms) and u.pm_id in ($pjs) and u.p_id=p.id and u.pm_id=c.id and u.pay_status=3 and p.termandcondition=1 and p.signortick=1 order by u.email_date";
...

    {
        ...
        $sql = "select u.*, p.title as p_title, c.f_name as pmf_name, c.l_name as pml_name , p.termandcondition as tnc from users u, projects p, com_admins c where u.com_id in ($cms) and u.p_id=p.id and u.pm_id=c.id and p.pm_id=c.id and u.pay_status=3 and p.termandcondition=1 and p.signortick=1 order by u.email_date";
