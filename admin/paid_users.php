<?php
    ...
    $sql="select u.*, p.title, a.f_name as pmf_name, p.project_reference as p_ref, a.l_name as pml_name from users u, projects p, com_admins a where  u.pay_status='5' and u.p_id=p.id and u.pm_id=a.id order by u.email_date";    
