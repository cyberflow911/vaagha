            ...
            <form method="post">
                ...
                <div class="row">
                    ...
                    ?>
                                    ...
                                    <button type="submit" name="edit" class="btn btn-primary" style="margin-top:10; font-size: 14px; padding: 10px;" value="">Edit</button>
                        ...
                        ?>
                                    ...
                                    <button type="submit" name="next" class="btn btn-primary" style="margin-top:10; font-size: 14px; padding: 10px;" value="">Next</button>
