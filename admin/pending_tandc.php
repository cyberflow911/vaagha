<?php
    ...
    $sql="select u.*, p.title, a.f_name as pmf_name, a.l_name as pml_name from users u, projects p, com_admins a, bank_details b where b.p_tandc!='1' and u.pay_status='3' and u.p_id=p.id and u.pm_id=a.id and p.termandcondition=1 and b.u_id=u.id and p.signortick=1 order by u.email_date";  
