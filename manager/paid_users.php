<?php
    ...
    $sql="select u.*, p.title, p.project_reference as p_ref from users u, projects p where u.pm_id='$MANAGER_ID' and u.pm_id=p.pm_id and u.pay_status='5' and u.p_id=p.id;";    
