...

    {
        ...
        switch ($token) {
            ...
            case '1':
                ...
                $sql="select u.*, p.title from users u, projects p where u.status=1 and u.pm_id='$MANAGER_ID' and u.p_id=p.id";
            ...
            case  "2":
                ...
                $sql="select u.*, p.title from users u, projects p where u.status=0 and u.pm_id='$MANAGER_ID' and u.p_id=p.id";
            ...
            case "3": 
                ...
                $sql="select u.*, p.title from users u, projects p where u.pm_id='$MANAGER_ID' and u.p_id=p.id and u.status!=2";
                    ...
                    ?> 
                                    ...
                                    <tr> 
                                        ...
                                        <form method="post">
                                            ...
                                            <a href="useraddedit?token=<?=$detail['id']?>" class="btn btn-success" value="<?=$detail['id']?>"> <i class="fa fa-edit">Edit</i> </a>

                                            <button  class="btn btn-danger" onclick="return confirm('Are You Sure You want to Delete <?=$detail['f_name']?> <?=$detail['l_name']?>?')" type="submit" name="delete" value="<?=$detail['id']?>">
