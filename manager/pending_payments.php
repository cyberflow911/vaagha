<?php
    ...
    $sql="select u.*, p.title, b.p_tandc_date as tncdate from users u, bank_details b, projects p where u.pm_id='$MANAGER_ID' and u.pay_status='4' and u.p_id=p.id and b.u_id=u.id";    
