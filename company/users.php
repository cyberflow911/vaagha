...

    {
        ...
        switch ($token) {
            ...
            case '1':
                ...
                $sql="select u.*, p.title from users u, projects p where u.status=1 and u.com_id='$COMPANY_ID' and u.p_id=p.id";
            ...
            case  "2":
                ...
                $sql="select u.*, p.title from users u, projects p where u.status=0 and u.com_id='$COMPANY_ID' and u.p_id=p.id";
