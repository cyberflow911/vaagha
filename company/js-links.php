  ...
  $(function () {
    ...
    $('#example2').DataTable({ 
      dom: 'Bfrtip',
        buttons: [
          { extend: 'copy', 
            className: 'btn btn-primary glyphicon glyphicon-duplicate tableBtns', 
            exportOptions: {
                    columns: ':visible'
                } 
          },
          { extend: 'csv',
             className: 'btn btn-primary glyphicon glyphicon-save-file tableBtns',
             exportOptions: {
                    columns: ':visible'
                }
          },
          { extend: 'excel',
            className: 'btn btn-primary glyphicon glyphicon-list-alt tableBtns',
            exportOptions: {
                    columns: ':visible'
                }
          },
          { extend: 'pdf', 
            className: 'btn btn-primary glyphicon glyphicon-file tableBtns',
            exportOptions: {
                    columns: ':visible'
                }
          },
          { extend: 'print', 
            className: 'btn btn-primary glyphicon glyphicon-print tableBtns',
             exportOptions: {
                    columns: ':visible'
                }
          },
          { extend:  'colvis', 
            className: 'btn btn-primary glyphicon glyphicon-eye tableBtns' },
        ],
        select: true,
      'paging'      : true,
      'lengthChange': true,
