<?php
    ...
    $sql="select u.*, p.title, a.f_name as pmf_name, a.l_name as pml_name from users u, projects p, com_admins a, bank_details b where u.com_id='$COMPANY_ID' and b.p_tandc!='1' and u.pay_status='3' and u.p_id=p.id and u.pm_id=a.id and p.termandcondition=1 and b.u_id=u.id and p.signortick=1 order by u.email_date";    
                        ...
                        <table class="table">
                            ...
                            <thead style="background-color: #212529;">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" style="text-align: center;">Move to Pend. Payment</th>
                                </tr>
                            ...
                            ?> 
                                            ...
                                            <tr id="row<?=$detail['id']?>"> 
                                                ...
                                                <td style="  text-align: center; " scope="row" id="serialNo<?=$i?>">

                                                <input type="checkbox" id="checkbox" value="<?=$detail['id']?>"></td> 
                                                ...
                                                <td style="  text-align: center; " > <button class="btn btn-success" type="button" onclick="movetopendpay(<?=$detail['id']?>)"><i class="fa fa-check"></i>&nbspMove</button></td>
        ...
        $.ajax({
            ...
            success:function(response)
            {
                ...
                if(obj.msg=="ok")
                {
                    $("#row"+uid).remove();
                    $("#showmsg").show()
                    $("#showmsg").html("User Moved Sucessfully");
                }
