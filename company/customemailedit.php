    ...
    require_once 'left-navbar.php';;
        ...
        if(isset($_GET['token'])&&!empty($_GET['token']))
        {
            ...
            if(isset($_POST['edit']))
            {
                ...
                $sql="update customise_email set subject='$subject', body='$body', name='$name', greetings='$greetings', endgreetings='$endgreetings'";
                if($conn->query($sql))
                {
                    $resMember=true;
                }
        ...
        $sql="Select * from customise_email where id=$token";
