...

        {
           ...
           if($result =  $conn->query($sql))
...

            {
                ...
                if(upload_tandc2($_FILES,$conn,"projects","id","tandcfile",$pid,"projectFile",$website_link."/company/uploads"))
...

            {
                ...
                if(upload_tandc($_FILES,$conn,"projects","id","tandcfile",$pid,"projectFile",$website_link."/company/uploads"))
...

        {
...

            {
...

                {
                    ...
                    $sql="select * from com_admins where email='$pm_email' and type='2' and c_id='$COMPANY_ID'";
...

                    {
...

                        {
                            ...
                            $sql="select * from projects where project_reference='$p_ref' and pm_id='$pmid' and cm_id='$COMPANY_ID'";
...

                            {
...

                                {
                                    ...
                                    $sql="select * from users where p_id='$pid' and pm_id='$pmid' and email='$data[15]' and com_id='$COMPANY_ID'";
...

                                    {
...

                                        {
                                          ...
                                          $sql = "insert into users(salutation, f_name, l_name, email, m_num, pm_id, p_id, com_id, status, pay_status, incentive) values('$data[12]','$data[13]', '$data[14]','$data[15]','$data[16]',$pmid,$pid,'$COMPANY_ID', 1, 6, '$data[17]')";
...

                                {
                                   ...
                                   $sql="insert into projects(title, project_reference,description,incentive,participants, group_num, start_date, termandcondition, pm_id, cm_id,status, signortick) values('$data[0]','$data[1]','$data[2]','$data[6]','$data[7]','$data[8]','$data[9]','$data[10]', $pmid, '$COMPANY_ID',1,'$data[11]')";
...

                        {
                            ...
                            $sql="insert into com_admins(f_name,l_name, c_id, m_num, email, type, status) values('$f_name', '$l_name', '$COMPANY_ID', '$data[4]', '$data[5]',2,1)";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" style="font-size: 16px;" onchange="check(this)" id="userm_num"  name="userm_num" class="form-control" value="0" required>  
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="userbulkadd" class="btn btn-primary" style="margin-top:10; width: 65px; height: 30px; padding-right:10px; font-size: 16px;">Submit</button>
