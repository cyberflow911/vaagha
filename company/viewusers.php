<?php
    ...
    {
        $token=$_GET['token'];
        $sql="select pm.name as pmname, u.*, p.title, p.description, p.start_date, p.incentive from projects p, users u, projectmanager pm where u.pm_id=pm.id and u.id='$token' and u.p_id=p.id and u.com_id='$COMPANY_ID'";
