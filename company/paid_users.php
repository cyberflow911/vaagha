<?php
    ...
    $sql="select u.*, p.title, p.project_reference as p_ref, a.f_name as pmf_name, a.l_name as pml_name from users u, projects p, com_admins a where u.com_id='$COMPANY_ID' and u.pay_status='5' and u.p_id=p.id and u.pm_id=a.id order by u.email_date";    
                        ...
                        <table class="table" id="example2">
                            ...
                            ?> 
                                            ...
                                            <tr> 
                                                ...
                                                <td style="  text-align: center; " id="pay_ref<?=$i?>"><?=$detail['p_ref'];?></td>
