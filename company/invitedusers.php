<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if(isset($_POST['edit']))
        {
            ...
            $m_num=$_POST['emobile'];
            $id=$_POST['eid'];
            $sql="update users set password='$password', salutation='$salutation', m_num='$m_num', f_name='$f_name', l_name='$l_name', status='1', pay_status=6, incentive='$incentive' where id='$id'";
            if($conn->query($sql))
            {
                $resMember = "true"; 
            }
