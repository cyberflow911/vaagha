...
if(isset($_POST['sendMail']) && isset($_POST['invite']))
{
    ...
    foreach($userdata as $data)
    {
        ...
        try {
            ...
            $mail->Subject = $sub;
            $mail->Body    ="<p style='font-size: 14px'>$greet</p><br><p style='font-size: 14px'>$bd</p><br><br><p style='font-size: 14px'>$endgreet</p>";
        ...
        {
            $sql2="update users set pay_status=1 where id='".$data['id']."'";
            if($conn->query($sql2))
            {
                $resMember=true;
            }
