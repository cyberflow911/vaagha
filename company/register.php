                                    ...
                                    <div class="form-holder form-holder-2">
                                        <fieldset>
                                            ...
                                            <input type="text" class="form-control" id="cpost" name="cpost"
                                                placeholder="12AB34" required pattern="[a-zA-Z0-9]">
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="form-row">
                    ...
                    for (i = 0; i < arr.length; i++) {
                        ...
                        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                            ...
                            b.addEventListener("click", function(e) {
                                ...
                                $("#address").val(companyDetails[0].address_snippet)
                                $("#reg-num").val(companyDetails[0].company_number)
                                $("#cpost").val(companyDetails[0].address.postal_code);
                                // address
    ...
    function searchCompany(val)
    {
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $("#address").val(obj.registered_office_address.address_line_1+","+obj.registered_office_address.locality+","+obj.registered_office_address.region+","+obj.registered_office_address.country+","+obj.registered_office_address.postal_code) 
                $("#cpost").val(obj.registered_office_address.postal_code);
            },
            error: function(data)
            {
